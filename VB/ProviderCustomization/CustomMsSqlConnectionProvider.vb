...
Namespace ConsoleProviderCustomization
    Public Class CustomMsSqlConnectionProvider
        ...
        Shared Sub New()
            Register()
            RegisterDataStoreProvider(XpoProviderTypeString, AddressOf CustomCreateProviderFromString)
            RegisterDataStoreProvider("System.Data.SqlClient.SqlConnection", AddressOf CreateCustomProviderFromConnection)
